return {
  ...
  },
  {
    ...
    workspace_text      = "Having CBT session with %s",            -- Format string rendered when in a git repository (either string or function(project_name: string|nil, filename: string): string)
